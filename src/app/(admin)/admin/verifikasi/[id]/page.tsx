...
function buildMock(id: string): PendaftarDetail {
  return {
    id,
    nomorPendaftaran: `SPMB-2025-${id.replace(/\D/g, "").slice(0, 5).padStart(5, "0")}`,
    namaLengkap:      "Ahmad Fauzi Ramadhan",
    email:            "ahmad.fauzi@email.com",
    programStudi:     "Teknik Informatika",
    asalSekolah:      "SMA Negeri 3 Depok",
    jalur:            "Reguler",
    status:           "menunggu",
    dokumen: [
      { id: "d1", jenis: "KTP / Kartu Pelajar",  namaFile: "ktp_ahmad.jpg",        format: "JPG",  ukuran: 524_288,   uploadedAt: "2025-06-01T08:30:00Z", url: "#" },
      { id: "d2", jenis: "Ijazah / SKL",           namaFile: "ijazah_ahmad.pdf",     format: "PDF",  ukuran: 1_572_864, uploadedAt: "2025-06-01T08:32:00Z", url: "#" },
      { id: "d3", jenis: "Transkrip Nilai",         namaFile: "transkrip_ahmad.pdf",  format: "PDF",  ukuran: 983_040,   uploadedAt: "2025-06-01T08:33:00Z", url: "#" },
      { id: "d4", jenis: "Pas Foto 3×4",            namaFile: "foto_ahmad.jpg",       format: "JPG",  ukuran: 262_144,   uploadedAt: "2025-06-01T08:34:00Z", url: "#" },
      { id: "d5", jenis: "Bukti Pembayaran",        namaFile: "bukti_bayar_ahmad.pdf",format: "PDF",  ukuran: 712_704,   uploadedAt: "2025-06-01T08:35:00Z", url: "#" },
    ],
  };
}
...
const PreviewModal = ({
  ...
  <Modal
    isOpen={!!doc}
    onClose={onClose}
    title={doc?.jenis ?? "Preview Berkas"}
  >
    {doc && (
      <div className="space-y-4">
        ...
        {["jpg", "jpeg", "png", "webp"].includes(doc.format.toLowerCase()) ? (
          <div className="flex h-48 items-center justify-center overflow-hidden rounded-lg border border-neutral-200 bg-neutral-100">
            {/* In production this would be doc.url */}
...
export default function VerifikasiDetailPage() {
  ...
  // ── Fetch detail ──
  const { data, isLoading, isError } = useQuery<PendaftarDetail>({
  ...
  // Fall back to mock when API not available
  const pendaftar: PendaftarDetail = isError || !data ? buildMock(id) : data;
  const totalDok   = 5;
  const uploadedDok = pendaftar.dokumen.length;
  ...
  const { mutate: submitKeputusan, isPending } = useMutation({
    ...
    onError: () => {
      // In dev with mock, simulate success
      const isSetujui = confirmAction === "setujui";
      toast.success(
        isSetujui
          ? "Berkas berhasil diverifikasi! (mode demo)"
          : "Berkas ditolak. (mode demo)",
        { duration: 4000 }
      );
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
                  ...
                  {isLoading ? (
                    ...
                    <>
                      ...
                      <dl className="space-y-2.5 text-sm">
                        {[
                          { label: "Program Studi", value: pendaftar.programStudi },
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="h-2 overflow-hidden rounded-full bg-neutral-100">
                          <div
                            ...
                            style={{
                              width: `${(uploadedDok / totalDok) * 100}%`,
                            }}
                            role="progressbar"
          ...
          <div className="space-y-5 lg:col-span-2">
            ...
            <SectionCard>
              ...
              {/* Empty */}
              {!isLoading && pendaftar.dokumen.length === 0 && (
            ...
            <SectionCard>
              ...
              <div className="p-5 space-y-4">
                ...
                {/* Disabled hint when docs incomplete */}
                {!allComplete && (
